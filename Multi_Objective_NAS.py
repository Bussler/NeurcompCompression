...
def create_NoDropout_experiment_scheduler(config, scriptname="NeurcompTraining.py", expname='mhd_p_', directory_name='', total_trials=48):
...
def create_variational_experiment_scheduler(config, scriptname="NeurcompTraining.py", expname='mhd_p_', directory_name='', total_trials=80):
